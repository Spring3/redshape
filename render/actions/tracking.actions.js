...
const trackingStart = (issue, actionDate) => ({ type: TRACKING_START, data: { issue, actionDate } });
const trackingStop = (duration, comments) => ({ type: TRACKING_STOP, data: { duration, comments } });
const trackingPause = (duration, comments, actionDate) => ({ type: TRACKING_PAUSE, data: { duration, comments, actionDate } });
const trackingContinue = (duration, comments, actionDate) => ({ type: TRACKING_CONTINUE, data: { duration, comments, actionDate } });
